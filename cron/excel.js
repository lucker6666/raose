...
for (var i in config) {
    ...
    (function(i, ids) {
        httpGet('http://173.208.199.49:8888/api/ga.json?max-results=10000&ids=ga%3A' + ids + '&dimensions=ga%3Adate&start-date=2013-06-15&end-date=' + daysAgo(2) + '&metrics=ga%3Apageviews%2Cga%3Avisits', function(data) {
            var raw = data.rows;
            // 处理浏览量日增
